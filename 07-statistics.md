...
B = Elvin is a identical or fraternal twin
P(A) = 1/125
P(B) = 1/125 + 1/300
P(B|A) = 1
P(A|B) = (1 * 1/125)/(1/125 + 1/300)
       = 71%
...
Bayesian statistics is based on a prior hypothesis, while frequentist statistics is based entirely on the data. In Bayesian statistics, the prior hypothesis alters the conclusion drawn, while in frequentist statistics, the data accepts or refutes the proposed hypothesis. 
